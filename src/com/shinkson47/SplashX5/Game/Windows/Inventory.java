...
public class Inventory {
	...
	public static void RenderFrame() {
		...
		graphics.drawImage(ResourceManager.getTexture("UI/Inventory"), ClientWindow.window.getWidth() / 2 - Game.TileSize * Player.players[Client.PlayerID].inventory.Inventory.length - Game.TileSize, ClientWindow.window.getHeight() / 2 - Game.TileSize * Player.players[Client.PlayerID].inventory.Inventory[1].length - Game.TileSize, null, null);
		graphics.drawImage(ResourceManager.getTexture("UI,SmallCrafting"), ClientWindow.window.getWidth() / 2 - Game.TileSize * Player.players[Client.PlayerID].inventory.Inventory.length - (Game.TileSize * Player.players[Client.PlayerID].inventory.CraftingGrid[0].length * 2 + Game.TileSize * 3), ClientWindow.window.getHeight() / 2 - Game.TileSize * Player.players[Client.PlayerID].inventory.Inventory[1].length - Game.TileSize, null, null);
		...
		try {
			...
			if (Player.players[Client.PlayerID].inventory.InMotion == null)
				return;
